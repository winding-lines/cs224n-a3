...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        value = self.pretrained_embeddings(t)
        batch_size, n_features = t.size()
        x = value.view(batch_size, n_features * self.embed_size)
    ...
    def forward(self, t):
        ...
        hidden_raw = self.embed_to_hidden(embeddings)
        hidden = F.relu(hidden_raw)
